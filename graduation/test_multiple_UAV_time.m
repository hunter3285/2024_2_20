function [rate_dp, N_SAR_dp, comm_rate_dp, rate_sens, N_SAR_sens, comm_rate_sens,...
    rate_comm, N_SAR_comm, comm_rate_comm]=test_multiple_UAV_time(time, Multiple_UAV_Solver_inst)
m=Multiple_UAV_Solver_inst;
m.time_slot_max=time;
m.power_initial_vec=ones(1, time)*m.p_mean;
m.p_max_total= m.time_slot_max* m.p_mean;
