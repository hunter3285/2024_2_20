classdef A_star_Solver < Path_Solver
    properties
        node_list;
        dest;
...
%         save_power(obj)
        create_node_list(obj)
        node=find_node(obj, x, y, direction)
        replace_node_in_node_list(obj, node)
        get_first_step(obj)
        sort_cost(obj)
        check_neighbor_nodes(obj, x, y, direction)
        node=extract_min_unvisited_node(obj)
        get_A_star_result(obj)
        function obj=A_star_Solver(UAV_Solver_instance)
